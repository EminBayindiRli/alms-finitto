  ...
  <div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="mb-8 flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-gray-900">Eğitim Yönetimi</h1>
          <p class="mt-1 text-sm text-gray-500">
            Çalışanlar için eğitim programlarını oluşturun ve yönetin
          </p>
        </div>
      ...
      <!-- Bu bileşen şu an sadece bir iskelet olarak oluşturuldu -->
      <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <div class="p-6 text-center text-gray-500">
          <AcademicCapIcon class="mx-auto h-12 w-12 text-gray-400" />
          <h3 class="mt-2 text-lg font-medium text-gray-900">Eğitim Yönetimi Sayfası Yapım Aşamasında</h3>
          <p class="mt-1 text-sm text-gray-500">Bu bileşen henüz tamamlanmadı. Yakında burada eğitim yönetim araçları yer alacak.</p>
        </div>
      </div>
    </div>
  </div>
