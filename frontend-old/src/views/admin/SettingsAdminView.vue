    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <div class="p-6 text-center text-gray-500">
          ...
          <h3 class="mt-2 text-lg font-medium text-gray-900">Ayarlar Sayfası Yapım Aşamasında</h3>
          <p class="mt-1 text-sm text-gray-500">Bu bileşen henüz tamamlanmadı. Yakında burada sistem ayarları yer alacak.</p>
        </div>
      </div>
    </div>
  </div>
